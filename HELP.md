...
* The original package name 'communication.spring-chatgpt-communication' is invalid and this project uses 'communication.springchatgptcommunication' instead.
